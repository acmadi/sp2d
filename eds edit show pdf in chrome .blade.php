...
function showThumbnail(files){
   ...
   //when the file is read it triggers the onload event above.
       // reader.readAsDataURL(pdffile);// untuk mozilla udang ok  tapi untuk chrome Uncaught TypeError: Failed to execute 'readAsDataURL' on 'FileReader': parameter 1 is not of type 'Blob'.
                    ...
                    <DIV style="min-width:30%; display:inline-block;" >
                     <label  for="unit_kerja_id">
 							...
 							<div > 
                                ...
                                :  <input id="penerima_id" name="penerima_id" value="">[F1] + Penerima baru //  {!! button_refresh('reload_penerima_id') !!}
      ...
      <i class="fa fa-file-pdf-o fa-6" style=" font-size: 50px;  color: rgb(0,0,255);"></i>
        <!-- <a>   Klik disini untuk menambakan gambar</a> -->
            ...
            <!-- <button value="" onclick="javascript:xxxxx()"> Buka PDF di endela baru</button> -->
             <!-- <iframe  id="pdf" style="width:500px; height=500px; "> -->
             <div id="pdf" >
